...
import com.sda.fastlogistics.databinding.ActivityViewPetrolBinding;
 ...
 */
public class ViewPetrol extends AppCompatActivity {
    /**
    ...
    private ActivityViewPetrolBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        binding = ActivityViewPetrolBinding.inflate(getLayoutInflater());
